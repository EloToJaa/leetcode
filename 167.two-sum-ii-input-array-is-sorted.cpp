...
// target number. Let these two numbers be numbers[index₁] and numbers[index₂]
// where 1 <= index₁ < index₂ <= numbers.length.
//
// Return the indices of the two numbers index₁ and index₂, each incremented by
