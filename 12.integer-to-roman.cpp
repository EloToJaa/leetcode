...
// maximal value that can be subtracted from the input, append that symbol to
...
// IX. Only the following subtractive forms are used: 4 (IV), 9 (IX), 40 (XL),
// 90 (XC), 400 (CD) and 900 (CM). 	Only powers of 10 (I, X, C, M) can be
