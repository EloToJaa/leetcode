...
// each should contain 1 flower. After day 1: [x, _, _, _, _]   // we can only
// make one bouquet. After day 2: [x, _, _, _, x]   // we can only make two
// bouquets. After day 3: [x, _, x, _, x]   // we can make 3 bouquets. The
// answer is 3.
//
//
// Example 2:
