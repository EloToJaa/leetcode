...
// Returns true if the item was not present, false otherwise. 	bool remove(int
// val) Removes an item val from the set if present. Returns true if the item
// was present, false otherwise. 	int getRandom() Returns a random element from
