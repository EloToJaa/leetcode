...
// create a new 0-indexed integer array newNums of length n - 1. 	For each index
// i, where 0 <= i < n - 1, assign the value of newNums[i] as (nums[i] +
// nums[i+1]) % 10, where % denotes modulo operator. 	Replace the array nums with
