...
// 5 days like this: 1st day: 1, 2, 3, 4, 5 2nd day: 6, 7 3rd day: 8 4th day: 9
// 5th day: 10
//
...
// 3 days like this: 1st day: 3, 2 2nd day: 2, 4 3rd day: 1, 4
//
//
// Example 3:
//
...
class Solution {
 private:
  bool check(const vector<int>& weights, int c, int days) {
